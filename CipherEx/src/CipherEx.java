 ...
 *  It uses try and catch to catch errors throughout reading and writing files.
 *  CS108-1
 *  02/24/20
...
public class CipherEx {
    ...
    public static void main(String[] args) /* FIX ME */  {
        ...
        //exits if args is less than 3.
            ...
            System.out.println("Wrong number of Args inputs.");
            System.exit(1);
        }
    }
     ...
     * @return Scanner
     */
    private static Scanner openInput(String filename){
        Scanner scan = null;
            try {
     ...
     *
     */
    private static PrintWriter openOutput(String filename){
    ...
    public static char shiftDownByK(char c, int offset) {
        //Uses the numeric values of characters
    ...
    private static String getOutputFilename(String inputFilename, int action) {
        ...
        return "Change the value of action";
    }
